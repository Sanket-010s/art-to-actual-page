      ...
      <div className="relative z-10 container mx-auto px-8">
        ...
        >
          ...
          <div className="flex gap-4 mt-8">
            <Link
              to="/resume"
              className="px-6 py-2 border border-foreground/30 text-foreground text-sm font-body hover:bg-primary hover:border-primary hover:text-primary-foreground transition-all"
            >
              Resume
            </Link>
            <Link
