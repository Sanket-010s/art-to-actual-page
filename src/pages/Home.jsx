          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-8">
                ...
                >
                  {roles1.map((role, i) => (
                    <span key={role} className="flex items-center gap-1">
                      ...
                      {i < roles1.length - 1 && (
                        <span className="text-primary/40 mx-2 text-lg select-none">·</span>
                      )}
                    </span>
                  ))}
                </motion.div>
                ...
                >
                  {roles2.map((role, i) => (
                    <span key={role} className="flex items-center gap-1">
                      ...
                      {i < roles2.length - 1 && (
                        <span className="text-primary/30 mx-2 text-lg select-none">·</span>
                      )}
                    </span>
                  ))}
                </motion.div>
            ...
            >
              ...
              <motion.div
                ...
                style={{ width: "calc(100% + 110px)", height: "calc(100% + 110px)" }}
              />
